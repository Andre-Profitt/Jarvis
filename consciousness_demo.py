...
async def demo_consciousness():
    ...
    for action in actions:
        ...
        print(
            f"   Action '{action}': {len(plan['steps'])} steps, {plan['duration']}s duration"
        )
    ...
    print(
        f"   Healing interventions: {report['performance_metrics']['healing_interventions']}"
    )
    print(
        f"   Average coherence: {report['performance_metrics']['average_coherence']:.3f}"
    )
