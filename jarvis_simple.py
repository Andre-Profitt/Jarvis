...
• And much more! What would you like to explore?"""
            ...
            return f"I remember our last {len(recent_memory)} interactions. You've been asking about: " + \
                   ", ".join([m.get('user', '')[:30] + "..." for m in recent_memory if 'user' in m])
...
• Or ask me anything else!"""
            ...
            return "Goodbye! It was a pleasure assisting you. Feel free to return anytime!"
