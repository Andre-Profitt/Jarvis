...
class VoiceFirstInterface:
    ...
    async def _understand_command(self, text: str) -> VoiceCommand:
        ...
        context = self.context_manager.get_context(
            self.conversation_history, self.active_context
        )
    ...
    async def _execute_voice_command(self, command: VoiceCommand) -> str:
        ...
        handler = intent_handlers.get(command.intent, self._handle_general_intent)
...
class NaturalVoiceExamples:
    ...
    def example_conversations():
        ...
        print(
            "🤖 JARVIS: 'I see you have the ML pipeline project open. Would you like me to run the tests or check for any issues?'"
        )
        print("🗣️ You: 'Yeah, run them'")
        print(
            "🤖 JARVIS: 'Running tests now... All 47 tests passed! I noticed the model accuracy improved by 3% since yesterday.'"
        )
        ...
        print(
            "🤖 JARVIS: 'I see the data processing is running slowly. I can optimize it by implementing parallel processing. Should I go ahead?'"
        )
        print("🗣️ You: 'Please'")
        print(
            "🤖 JARVIS: 'Optimizing now... Done! Processing time reduced from 45 seconds to 3 seconds.'"
        )
        ...
        print(
            "🤖 JARVIS: 'You were working on the Q4 investor presentation yesterday at 3 PM. It's in your Documents/Presentations folder, and you also have a backup in Google Drive.'"
        )
        print("🗣️ You: 'Thanks! Can you open it?'")
        print(
            "🤖 JARVIS: 'Opening now. By the way, your presentation meeting is in 2 hours. Would you like me to do a final review for any issues?'"
        )
