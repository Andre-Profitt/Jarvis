"""
Test Suite for Gcs Storage
======================================
Comprehensive tests for gcs_storage module.
"""
import pytest
import asyncio
...
try:
    from core.gcs_storage import *
except ImportError:
    # Handle modules that may not have proper exports
    import core.gcs_storage


class TestGcsStorage:
    """Test suite for GcsStorage"""
