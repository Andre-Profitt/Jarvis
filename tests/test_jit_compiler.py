...
======================================
Comprehensive tests for jit_compiler module.
"""
import pytest
import asyncio
...
try:
    from core.jit_compiler import *
except ImportError:
    # Handle modules that may not have proper exports
    import core.jit_compiler


class TestJitCompiler:
    """Test suite for JitCompiler"""
