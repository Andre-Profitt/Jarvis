...
from core.quantum_swarm_optimization import (
    QuantumAgent, QuantumAgentType, QuantumState,
    QuantumMemory, CollectiveIntelligence, EntanglementTopology,
    QuantumSwarmOptimizer, QuantumSwarmEnsemble, QuantumUtilities
)
...
class TestCollectiveIntelligence:
    ...
    def test_topology_creation(self):
        ...
        collective_full = CollectiveIntelligence(agents.copy(), EntanglementTopology.FULLY_CONNECTED)
        ...
        collective_sw = CollectiveIntelligence(agents_sw, EntanglementTopology.SMALL_WORLD)
        # Small world should have fewer connections
        avg_connections = sum(len(agent.entangled_agents) for agent in collective_sw.agents.values()) / 6
    ...
    async def test_collective_state_update(self):
        ...
        assert collective.collective_coherence == 1.0  # All agents start with coherence 1
...
class TestPerformanceBenchmarks:
    ...
    async def test_convergence_speed(self):
        ...
        optimizer1 = QuantumSwarmOptimizer(n_agents=20, dimension=10, max_iterations=500)
        optimizer2 = QuantumSwarmOptimizer(n_agents=20, dimension=10, max_iterations=500)
