...
class RealOpenAIIntegration:
    ...
    def _prepare_messages(self, 
        ...
        if conversation_id and conversation_id in self.conversations:
            messages.extend(self.conversations[conversation_id][-10:])  # Last 10 messages
    ...
    async def _get_completion(self, messages: List[Dict[str, str]], temperature: float) -> str:
    ...
    async def _stream_completion(self, messages: List[Dict[str, str]], temperature: float) -> str:
    ...
    async def _fallback_query(self, prompt: str, context: Optional[Dict[str, Any]]) -> str:
