...
class SelfHealingJARVISIntegration:
    ...
    def _setup_monitoring_hooks(self):
        ...
        self.monitoring.register_metric("healing_anomalies_detected",
            lambda: len(self.healing_system.anomaly_buffer))
        self.monitoring.register_metric("healing_fixes_applied",
            lambda: len(self.healing_system.fix_history))
        self.monitoring.register_metric("healing_system_health",
            lambda: self._calculate_healing_health())
    ...
    async def _collect_system_metrics(self) -> SystemMetrics:
        ...
        metrics = SystemMetrics(
            ...
            custom_metrics={
                'neural_active_neurons': neural_status['neural_manager']['active_neurons'],
                'neural_energy_usage': neural_status['neural_manager']['energy_usage'],
                'neural_efficiency': neural_status['neural_manager']['network_efficiency'],
    ...
    def _calculate_healing_health(self) -> float:
        ...
        recent_fixes = [f for f in self.healing_system.fix_history 
    ...
    async def apply_manual_fix(self, fix_strategy: str, target_component: str) -> Dict[str, Any]:
    ...
    async def get_healing_status(self) -> Dict[str, Any]:
        ...
        recent_anomalies = [a for a in self.healing_system.anomaly_buffer 
        ...
        return {
            ...
            'monitoring': {
                ...
                'last_metric': self._metrics_buffer[-1].timestamp.isoformat() if self._metrics_buffer else None
            },
            'anomalies': {
            ...
            'learning': {
                ...
                'adaptive_learning': self.healing_system.config.get('adaptive_learning', True)
            },
            'timestamp': datetime.now().isoformat()
        }
