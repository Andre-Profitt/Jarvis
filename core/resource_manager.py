...
class ResourceManager:
    ...
    def __init__(self):
        ...
        self.enforcement_enabled = config_manager.get("resources.enforcement_enabled", True)
    ...
    def _load_limits(self) -> ResourceLimit:
        ...
        return ResourceLimit(
            ...
            max_concurrent_tasks=config_manager.get("resources.max_concurrent_tasks", 20),
            max_file_handles=config_manager.get("resources.max_file_handles", 100),
            max_network_connections=config_manager.get("resources.max_network_connections", 50)
        )
