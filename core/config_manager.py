...
class SynthesisConfig(BaseModel):
    ...
    synthesis_methods: List[str] = field(default_factory=lambda: [
        "pattern_based", "template_based", "neural", "example_based", "constraint_based"
    ])
...
class ConfigurationManager:
    ...
    def _create_synthesis_config(self) -> SynthesisConfig:
        ...
        synthesis_data.update({
            ...
            "semantic_cache_enabled": self.get("synthesis.cache.semantic_enabled", True),
            "semantic_cache_threshold": self.get("synthesis.cache.semantic_threshold", 0.85),
            "enable_sandbox": self.get("security.enable_sandbox", True),
            "sandbox_timeout": self.get("security.sandbox_timeout", 10),
            "sandbox_memory_limit": self.get("security.sandbox_memory_limit", "512MB"),
            "max_concurrent_syntheses": self.get("resources.max_concurrent_syntheses", 10),
        })
