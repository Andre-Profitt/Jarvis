...
class JARVISServer:
    ...
    async def process_message(self, data):
        ...
        if any(greeting in content for greeting in ["hello", "hi", "hey", "greetings"]):
            ...
            word in content
            for word in ["capabilities", "can you", "what do you do", "features"]
        ):
            ...
            response_text = (
                "You're welcome! Always happy to help. Is there anything else you need?"
            )
        elif "exit" in content or "quit" in content or "bye" in content:
            response_text = (
                "Goodbye! Feel free to reconnect anytime you need assistance."
            )
        else:
        ...
        return {
            ...
            "timestamp": datetime.now().isoformat(),
            "status": "success",
            "metadata": {"processing_time": "87ms", "confidence": 0.95},
        }
